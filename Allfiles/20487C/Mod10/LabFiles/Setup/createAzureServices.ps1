...
$password = 'Pa$$w0rd';
$serviceBusRelayName = "blueyonder10Relay-$initials";
...
$hubKeys = Get-AzureRmNotificationHubListKeys -AuthorizationRule DefaultFullSharedAccessSignature -ResourceGroup BlueYonder.Lab.10 -Namespace blueyonder10-$initials -NotificationHub blueyonder10Hub
