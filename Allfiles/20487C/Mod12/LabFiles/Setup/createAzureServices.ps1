...
$resourceGroupName = "BlueYonder.Lab.12"
...
$serverName = "blueyonder12-$initials";
$databaseName = "BlueYonder.Companion.Lab12";
$hubNamespaceName = "blueyonder12-$initials";
$hubName = "blueyonder12Hub";
$password = 'Pa$$w0rd';
$serviceBusRelayName = "blueyonder12Relay-$initials";
...
$hubKeys = Get-AzureRmNotificationHubListKeys -AuthorizationRule DefaultFullSharedAccessSignature -ResourceGroup BlueYonder.Lab.12 -Namespace blueyonder12-$initials -NotificationHub blueyonder12Hub
