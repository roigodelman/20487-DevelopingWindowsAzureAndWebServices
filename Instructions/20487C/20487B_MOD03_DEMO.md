...
7. In **Solution Explorer** , under the **MyApp** project, expand the **App_Start** folder, and then double-click **WebApiConfig.cs**.
...
11. To start the application without debugging, press Ctrl+F5. The Microsoft Edge browser will open.
12. In the address bar of the browser, append the **api/values** to the end of the address, and then press Enter.
>> When prompted by the Microsoft Edge browser, click **Open,** click **Try an app on this PC** , and then click **Notepad** to open the **values.json** file in Notepad.
...
17. In Solution Explorer, double-click **WebApiConfig.cs** under **App_Start** folder.
...
>> When prompted by the Microsoft Edge browser, click **Open**, and then click **Notepad** to open the **list.json** file in **Notepad**.
...
6. In the search results list, locate the **Microsoft ASP.NET Web API 5.2.3 Client Libraries** ,and then click **Install**.
